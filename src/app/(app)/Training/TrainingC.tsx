...
export default function TrainingC() {
    ...
    useEffect(() => {
        ...
        const chatCollectionRef = collection(database, 'TrainingC')
    ...
    const addChat = async () => {
        ...
        try {
            await addDoc(collection(database, 'TrainingC'), {
                exercise,
                qntRepeticao,
                qntSerie,
                userId,
    ...
    const handleDelete = async (TrainingId) => {
        try {
            await deleteDoc(doc(database, 'TrainingC', TrainingId))
